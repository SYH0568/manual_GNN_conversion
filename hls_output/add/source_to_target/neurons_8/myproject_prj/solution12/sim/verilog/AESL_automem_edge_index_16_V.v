...
module AESL_automem_edge_index_16_V (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.myproject.autotvin_edge_index_16_V.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.myproject.autotvout_edge_index_16_V.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 16;
parameter ADDR_WIDTH = 32'd 4;
parameter DEPTH = 32'd 13;
parameter DLY = 0.1;
